...
const ColumnsButton = memo(function ColumnsButton() {
  ...
  return (
    <Button size="small" variant="outlined" onClick={handleClick}>Columnas</Button>
  );
});
        ...
        renderCell: params => (
          <Box sx={{ display: 'flex', gap: 1 }}>
            <IconButton
              ...
              sx={{ color: '#2196f3', '&:hover': { background: 'rgba(33,150,243,0.1)' } }}
            >
  ...
  return (
    ...
    >
      <DataGrid
        ...
        localeText={{ toolbarColumns: 'Columnas', toolbarQuickFilterPlaceholder: 'Buscar' }}
        slotProps={{
          pagination: {
            labelRowsPerPage: '',
        ...
        sx={{
          ...
          '& .MuiDataGrid-panel .MuiDataGrid-columnsPanel .MuiFormControl-root': { display: 'none' },
          // Hide Show/Hide All if present
          '& .MuiDataGrid-panel .MuiDataGrid-columnsPanel [data-testid="show-hide-all"]': { display: 'none' },
        }}
      />
    </Card>
  );
