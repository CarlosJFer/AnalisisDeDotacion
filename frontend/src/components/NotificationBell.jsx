...
const NotificationBell = () => {
  ...
  const handleNotificationClick = (notification) => {
    ...
    if (notification.data?.action && (notification.data.action === 'upload' || notification.data.action === 'modify')) {
      ...
      >
        ...
        <Box sx={{ 
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <NotificationsIcon sx={{ color: isDarkMode ? 'rgba(255, 255, 255, 0.9)' : 'rgba(0, 0, 0, 0.8)' }} />
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 0.5 }}>
                          ...
                          {!notification.read && (
                            <Box sx={{
                              ...
                              height: 8,
                              borderRadius: '50%',
                              backgroundColor: getNotificationColor(notification.type, notification.data)
                            }} />
                          )}
                        </Box>
