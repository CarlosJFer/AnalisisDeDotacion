            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={6}>
                <Autocomplete
                  ...
                  onChange={(event, newValue) =>
                    handleFilterChange("secretarias", newValue)
                  }
                  renderInput={(params) => (
                    <TextField
                      {...params}
              ...
              <Grid item xs={12} md={6}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      handleFilterChange("tipoContratacion", e.target.value)
                    }
              ...
              <Grid item xs={12} md={4}>
                <Autocomplete
                  ...
                  onChange={(event, newValue) =>
                    handleFilterChange("departamento", newValue)
                  }
                  renderInput={(params) => (
                    <TextField
                      {...params}
              ...
              <Grid item xs={12} md={6}>
                ...
                <Slider
                  ...
                  onChange={(e, newValue) =>
                    handleFilterChange("antiguedadRange", newValue)
                  }
                  valueLabelDisplay="auto"
                  min={0}
                  max={40}
