...
const resources = {
  es: {
    translation: {
      ui: {
        noFilterFields: 'Esta sección no tiene datos de Secretaría/Subsecretaría/Dirección...',
        noDataWithFilters: 'No se encontraron datos con los filtros aplicados.'
      },
      dashboard: {
        planta: {
          title: 'Dashboard - Planta y Contratos',
          subtitle: 'Análisis detallado de la dotación municipal con gráficos especializados'
        },
        neike: {
  ...
  en: {
    translation: {
      ui: {
        noFilterFields: 'This section has no Secretaría/Subsecretaría/Dirección data...',
        noDataWithFilters: 'No data found for the applied filters.'
      },
      dashboard: {
        planta: {
          title: 'Dashboard - Staff and Contracts',
          subtitle: 'Detailed analysis of municipal staffing with specialized charts'
        },
        neike: {
...
i18n
  ...
  .init({
    resources,
    lng: (typeof window !== 'undefined' && window.localStorage && localStorage.getItem('lang')) || 'es',
    fallbackLng: 'es',
