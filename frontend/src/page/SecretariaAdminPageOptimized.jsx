...
const SecretariaAdminPageOptimized = () => {
  ...
  return (
    <Box sx={optimizedStyles.glassmorphism(isDarkMode, "high")}>
      ...
      {!editingSec && (
        <Card
          sx={{ ...optimizedStyles.glassmorphism(isDarkMode, "normal"), mb: 4 }}
        >
          <CardContent sx={{ p: 4 }}>
            ...
            >
              <TextField
                ...
                value={newSec.nombre}
                onChange={(e) =>
                  setNewSec({ ...newSec, nombre: e.target.value })
                }
                size="small"
                sx={{ minWidth: 250 }}
              />
              <TextField
                ...
                onChange={(e) =>
                  setNewSec({ ...newSec, funcion: e.target.value })
                }
                size="small"
                multiline
                maxRows={2}
              ...
              <FormControl size="small" sx={{ minWidth: 250 }}>
                ...
                <Select
                  ...
                  label="Pertenece a:"
                  onChange={(e) =>
                    setNewSec({ ...newSec, idPadre: e.target.value })
                  }
                >
              ...
              <TextField
                ...
                value={newSec.orden || ""}
                onChange={(e) =>
                  setNewSec({ ...newSec, orden: e.target.value })
                }
                size="small"
                sx={{ minWidth: 120 }}
              />
          ...
          <CardContent sx={{ p: 4 }}>
            ...
            >
              ...
              <TextField
                ...
                onChange={(e) =>
                  setEditingSec({ ...editingSec, nombre: e.target.value })
                }
                size="small"
                sx={{ minWidth: 200 }}
              />
              <TextField
                ...
                onChange={(e) =>
                  setEditingSec({ ...editingSec, codigo: e.target.value })
                }
                size="small"
                sx={{ minWidth: 200 }}
              />
