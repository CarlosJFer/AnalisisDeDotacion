...
import { Button, Card, CardContent, Typography, CircularProgress, Alert, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Box, Snackbar, Tooltip, Avatar, Chip } from '@mui/material';
...
const UserRow = memo(({ 
  ...
  const handleDelete = useCallback(() => onDelete(user._id), [onDelete, user._id]);
  ...
  return (
    <TableRow
      sx={{
        '&:hover': {
          backgroundColor: isDarkMode ? 'rgba(255, 255, 255, 0.05)' : 'rgba(33, 150, 243, 0.05)',
        },
          ...
          <Tooltip title="Editar">
            <Button 
              ...
              sx={{
                ...
                borderColor: isDarkMode ? 'rgba(255, 255, 255, 0.3)' : 'rgba(33, 150, 243, 0.5)',
                '&:hover': {
                  backgroundColor: isDarkMode ? 'rgba(255, 255, 255, 0.15)' : 'rgba(33, 150, 243, 0.15)',
                  borderColor: isDarkMode ? 'rgba(255, 255, 255, 0.5)' : 'rgba(33, 150, 243, 0.8)',
                },
...
const UserAdminPageOptimized = () => {
  ...
  }, [editUser, editingUser, validateEditUser, resetEditUser, fetchUsers, showSnackbar]);
  ...
  }, [passwordForm, changingPassword, validatePasswordForm, resetPasswordForm, showSnackbar]);
  ...
  const handleOpenChangePassword = useCallback((user) => {
    ...
    >
      ...
      >
        <CardContent sx={{ p: 4 }}>
          ...
          <Box component="form" onSubmit={handleCreateUser} sx={{ display: 'flex', flexWrap: 'wrap', gap: 2, alignItems: 'flex-end' }}>
            <OptimizedTextField
              name="username"
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ 
                ...
                <TableCell sx={{ fontWeight: 600, fontSize: '0.9rem' }}>Usuario</TableCell>
                <TableCell sx={{ fontWeight: 600, fontSize: '0.9rem' }}>Email</TableCell>
                <TableCell sx={{ fontWeight: 600, fontSize: '0.9rem' }}>Rol</TableCell>
