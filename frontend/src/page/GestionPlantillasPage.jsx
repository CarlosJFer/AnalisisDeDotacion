...
const GestionPlantillasPage = () => {
  ...
  const cancelDelete = useCallback(
    () => setConfirm({ open: false, template: null, loading: false }),
    [],
  );
  ...
  return (
    ...
    >
      ...
      <Dialog
        open={confirm.open}
        onClose={confirm.loading ? undefined : cancelDelete}
        maxWidth="xs"
        fullWidth
      >
        ...
        <DialogContent>
          <Typography>
            ¿Estás seguro de eliminar la plantilla "{confirm.template?.name}"?
          </Typography>
        </DialogContent>
        <DialogActions>
          <Button
